...
Tickdroid is inspired by the "one-bit journal" Android app [Tickmate](https://f-droid.org/en/packages/de.smasi.tickmate/). It is a companion to the Nextcloud app [Tickbuddy](https://github.com/martinhammer/tickbuddy), also developed by me.
...
* Two-way sync with Tickbuddy's Nextcloud backend
...
At the time of starting this project there is no equivalent app in the Nextcloud ecosystem, and the Tickmate Androind application is no longer actively maintained.
